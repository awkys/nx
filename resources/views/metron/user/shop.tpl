...
{*                                                                </div>*}
                                                                ...
                                                                <div class="col pl-6 pt-6 pb-0">
                                                                    <div class="font-size-sm text-muted font-weight-bold">总流量</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body kt-padding-t-30">
                <p class="align-center pt-3" id="metronpay-modal-body-url" style="display: none;">如果支付失败，请重新下单，或更换微信支付，联系右下角客服</p>
