...
{*                <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image:url('../../images/bg01.jpeg');">*}
                <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(/theme/metron/images/useful/12.jpg);">
                    <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                        <div class="d-flex flex-center mb-10">
                            <a href="/">
                                <img src="/theme/metron/images/useful/tx2.png" class="max-h-100px bg-white shadow-light rounded-circle shadow" alt="" />
                            </a>
