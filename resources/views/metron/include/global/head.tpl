...
<body id="kt_body" {if $theme_style !== 'dark'}style="background-image: url(/theme/metron/images/useful/user-bg-01.png)"{/if} class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
