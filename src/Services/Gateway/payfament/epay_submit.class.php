...
class AlipaySubmit {
	...
	/*function buildRequestForm($para_temp, $method='POST', $button_name='正在跳转') {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysupayfamentbmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
