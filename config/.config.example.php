...
$_ENV['auto_backup_password'] = 'nx_Admin';                               //备份的压缩密码
$_ENV['backup_notify'] = false;                            //备份通知到TG群中


//【Metron】Crisp对接TG机器人--bob开发------------------------------------------------------------------------------------------
$_ENV['telegram_admin_id'] = '2111482452';  // 填写你的telegram唯一ID，如果不知道的可以去@userinfobot获取
...
$_ENV['crisp'] = [
    ...
    'auth_send_message' => [
        ...
        '余额' => '您好，请及时充值！',
        '没网' => '换个线路试一下',
        '人工' => '亲，人工客服在线时间为工作日：8：30 - 17：30',
        '连接失败' => "登陆{$_ENV['appName'] }，购买套餐，才可以连接",
        '机型' => "不用选择机型，我们支持所有设备，注册账号，登陆{$_ENV['appName'] }，购买套餐，按教程连接就可以了",
        '注册不' => '亲，可以去我们的新站注册，云轩加速器https://www.yuntey.com/auth/register',
        '怎么注册' => '亲，可以去我们的新站注册，云轩加速器https://www.yuntey.com/auth/register',
        '帐号无法登陆' => '亲，可以去我们的新站注册，云轩加速器https://www.yuntey.com/auth/register',
        '无法注册' => '亲，可以去我们的新站注册，云轩加速器https://www.yuntey.com/auth/register',
        '配置' => '亲，需要先购买套餐，才可以导入配置，参考网站最后一步教程',
        '导入' => '亲，需要先购买套餐，才可以导入配置，参考网站最后一步教程',
        '第四步' => '购买套餐后，用手机自带浏览器登陆网站，才可以导入',
        '无法导入' => '购买套餐后，用手机自带浏览器登陆网站，才可以导入',
        '获取订阅节点' => '购买套餐后，用手机自带浏览器登陆网站，才可以导入',
        '修改密码' => '亲，请在客服留言您的注册邮箱和要修改为的密码，工作人员会在12小时内修改。',
        '忘记密码' => '亲，请在客服留言您的注册邮箱和要修改为的密码，工作人员会在12小时内修改。',
        '密码忘了' => '亲，请在客服留言您的注册邮箱和要修改为的密码，工作人员会在12小时内修改。',
        '重置密码' => '亲，请在客服留言您的注册邮箱和要修改为的密码，工作人员会在12小时内修改。',
        '免费' => "亲，本站提供的是付费服务，登陆{$_ENV['appName'] }，点击购买套餐，就可以看见套餐列表了",
        '需要付费' => "亲，本站提供的是付费服务，登陆{$_ENV['appName'] }，点击购买套餐，就可以看见套餐列表了",
        '怎么收费' => "亲，本站提供的是付费服务，登陆{$_ENV['appName'] }，点击购买套餐，就可以看见套餐列表了",
        '海外账号' => "亲，本站提供的是付费服务，登陆{$_ENV['appName'] }，点击购买套餐，就可以看见海外苹果账号了",
        '苹果' => "亲，本站支持苹果访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        'iphone' => "亲，本站支持苹果访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        'ios' => "亲，本站支持苹果访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '安卓' => "亲，本站支持安卓访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '华为' => "亲，本站支持华为访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按安卓教程连接，即可访问外网",
        '小米' => "亲，本站支持小米访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按安卓教程连接，即可访问外网",
        'oppo' => "亲，本站支持oppo访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按安卓教程连接，即可访问外网",
        'vivo' => "亲，本站支持vivo访问海外网站，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按安卓教程连接，即可访问外网",
        '手机型号' => "亲，本站支持您的手机型号，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '如何连接' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '如何使用' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '开启vpn' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '怎么用' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '怎么使用' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '如何下载' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '怎么下载' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '下载软件' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '加速器下载' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '怎么连接' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '客户端下载' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '安装包' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，即可访问外网",
        '添加节点' => "登陆{$_ENV['appName'] }，购买套餐，下载软件，按教程添加即可",
        'ins' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，才可以登陆ins",
        'Instagram' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，才可以登陆ins",
        '推特' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，才可以登陆推特",
        'twitter' => "亲，您需要先登陆{$_ENV['appName'] }，点击首页购买套餐，按教程连接，才可以登陆推特",
        '电子邮件' => '电子邮件就是您常用的邮箱，例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱地址' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱格式' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱填什么' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱怎么' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '无效邮箱' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱无效' => '亲，使用您常用的邮箱就可以了。例如：123456@qq.com （注意在右侧选择邮箱后缀 @qq.com）',
        '邮箱不存在' => '系统会定期删除过期用户，重新注册就可以了',
        '连接不上' => "请先登陆{$_ENV['appName'] }购买套餐，确保套餐未过期，才可以连接",
        '没有显示账号密码' => '购买套餐后，刷新一下，查看最新密码。',
        '购买' => '亲，登陆本网站首页，点击购买套餐，下单付款，就可以了。',
        '试用' => '我们提供的是付费服务，请购买套餐后，按网站教程连接',
        '免费' => '我们提供的是付费服务，请购买套餐后，按网站教程连接',
        '续费' => '亲，登陆本网站首页，点击购买套餐，下单付款，就可以了。',
        '密码不对' => '密码是动态的，教程页面刷新一下，查看最新密码，不要开启双重验证',
        '验证' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号',
        '6位数' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号',
        '认证' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号',
        '解锁' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号',
        '锁定' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号',
        '账户被锁' => '苹果账号会在10分钟后自动解锁，刷新网站教程页面，查看最新密码，也可以使用教程里的备用海外苹果账号，下载后请退出账号'
    ],
    // 是否开启假节日回复
    'holiday_message' => [
        'open' => false,
        'message' => '您好，现在是节假日，客服小姐姐已经放假了哦，有问题请留言~'
    ]
];
...
$_ENV['telegram_token'] = '5705223425:AAEy6Px-CKXE2ba6JH-tdMF0mtl9aivHCfY';           //Telegram bot,bot 的 token ，跟 father bot 申请
...
#hybrid
$_ENV['epay'] = [
    'epay_api_url' => 'https://pay.hyss.org/',
    'epay_pid' => '1073',
    'epay_key' => 'APu5a2BjZ92VvX2K2a9AKxkpVBV2auee',
    'transport' => 'https',
];
